...
$sql = "INSERT INTO teachers (name, CreationDate)
VALUES ('$tname', '$adddate')";
              ...
              <div class="card-header">
                <div class="row" style="padding: 10px 20px;">
                    <div class="col-md-6 col-sm-6 col-6">
                      <h3 class="card-title">teachers Information</h3> 
                    </div>
                    <div class="col-md-6 col-md-6 col-sm-6 col-6" style="text-align: right;">
                      <button type="button" class="btn btn-success " data-toggle="modal" data-target="#add"><i class="fa fa-plus-circle"> Add Teacher</i>
                      </button>
                  </div>
                </div>
                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control"  placeholder="Enter Teacher Name" name="tname" required>
                                </div>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr id="<?php echo $row['id'];?>">
                    <td><?php echo ++$k; ?></td>
                    <td data-target="tname"><?php echo $row['name']; ?></td>
