...
$stock=$row['c_stock'];
 ...
 if ($stock>=$cquantity) {
   $totalstock=$stock-$cquantity;
 
$sql = "INSERT INTO chemical_consume (c_id, t_id, quantity, cdate)
VALUES ('$cid', '$tid', '$cquantity', '$adddate')";
...
if ($conn->query($sql) === TRUE) {
  ...
  echo "<script> window.location.href = 'consume-chemical.php';</script>";
}
}
else {
              ...
              <div class="card-header">
                <div class="row" style="padding: 10px 20px;">
                    <div class="col-md-6 col-sm-6 col-6">
                      <h3 class="card-title">Chemicals Consume Information</h3> 
                    </div>
                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Chemical Name</label>
                                ...
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Chemical Unit</label>
                                ...
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Quantity</label>
                                    ...
                                    <input type="number" class="form-control" name="cquantity" placeholder="Enter Cosumed Quantity">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php 
                    $k=0;
                   $sql1 = "SELECT * FROM chemical_consume";
